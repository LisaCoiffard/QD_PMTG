...
class A1(object):
    ...
    def get_IMU(self):
        """Get the robot's roll, roll rate, pitch, pitch rate"""

        # return np.array([self.get_base_roll_pitch_yaw()[:2],
        #                  self.get_base_roll_pitch_yaw_rate()[:2]]).reshape(-1)
    ...
    def get_observation(self):
        """Return the base pitch, roll, yaw, pitch rate, roll rate, yaw rate, 
        joint angles"""
        self.ReceiveObservation()
        return np.concatenate((self.get_motor_angles(),
                               np.array([self.get_base_roll_pitch_yaw(),
                                         self.get_base_roll_pitch_yaw_rate()]).reshape(-1)))
        # print("Obs dim = 29", np.concatenate((self.get_motor_angles(),
        #                        self.get_motor_velocities(),
        #                        self.get_base_roll_pitch_yaw()[:2],
        #                        self.get_base_roll_pitch_yaw_rate())))
        # print("Obs dim = 18", np.concatenate((self.get_motor_angles(),
        #                        np.array([self.get_base_roll_pitch_yaw(),
        #                                  self.get_base_roll_pitch_yaw_rate()]).reshape(-1))))
        # return np.concatenate((self.get_motor_angles(),
        #                        self.get_motor_velocities(),
